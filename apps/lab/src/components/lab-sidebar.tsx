...
import { LayoutDashboard, Calendar, Upload, Users, BarChart3, Beaker, LogOut } from "lucide-react";
        ...
        <div className="flex flex-col h-full bg-slate-900 text-white w-64 border-r border-slate-800">
            <div className="p-6 border-b border-slate-800">
                <div className="flex items-center gap-2">
                    ...
                    <span className="font-bold text-lg tracking-tight">LabLink Lab</span>
                </div>
            </div>
