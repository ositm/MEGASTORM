...
// Account creation lives in the patient app; labs claim with an existing account.
const PATIENT_APP_URL = process.env.NEXT_PUBLIC_PATIENT_APP_URL || 'https://megastorm-omega.vercel.app';
                ...
                <Card className="w-full max-w-md">
                    ...
                    <CardContent className="space-y-4">
                        ...
                        <Button asChild variant="outline" className="w-full">
                            <Link href={`${PATIENT_APP_URL}/auth/signup`}>Create Account</Link>
                        </Button>
                    </CardContent>
                </Card>
            </div>
